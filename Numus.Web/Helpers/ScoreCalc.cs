...
public static class ScoreCalc
{
    ...
    private const double DeployedContractsPercents = 2.77 / 100;
    ...
    private static double DeployedContractsScore(int contracts)
    {
        return contracts switch
        {
            < 1 => 3.38,
            < 5 => 7.63,
            < 10 => 15.75,
    ...
    public static double GetScore(this WalletStats stats)
    {
        var result = 0.0;
        ...
        result += DeployedContractsScore(stats.DeployedContracts) / 100 * DeployedContractsPercents;
